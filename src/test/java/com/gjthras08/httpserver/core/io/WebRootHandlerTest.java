...
import com.gjthras08.http.HttpParser;
...
public class WebRootHandlerTest {
    ...
    void constructorGoodPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("/Users/giothras/Desktop/CS Personal/java/httpserver/simplehttpserver/WebRoot");
